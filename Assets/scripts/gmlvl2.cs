...
public class gmlvl2 : MonoBehaviour
{
    ...
    public static List<string> availLetter1 = new List<string> () {"R"};
    public static List<string> availLetter2 = new List<string> () {"D"};
    public static List<string> availLetter3 = new List<string> () {"P"};
    public static List<string> availLetter4 = new List<string> () {"I"};
    public KeyCode RMB;
    public int wordLen;
    public static string word32L="RIP";
    public static string word31L="RID";
    public static string word3L="DIP";
    public static string word4L="DRIP";
    ...
    public static bool lvl3verif=false;
    ...
    void Update()
    {
        ...
        if (GameIsOver)
            return;
        if(CountDownTimer2.CurrentTime==0 && RightWords<4)    
            EndGame(); 
